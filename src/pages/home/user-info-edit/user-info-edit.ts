...
export class UserInfoEditPage {
    ...
    constructor(public  viewCtrl : ViewController,
        ...
        this.userInfoForm = formBuilder.group({
            ...
            phone1: new FormControl('',Validators.compose([Validators.required,Validators.minLength(11)])),
        ...
        this.phone2 = this.userInfoForm.controls['phone2'];
        this.email = this.userInfoForm.controls['email'];
        // this.phone1 = this.userInfoForm.controls['phone1'];
    }
    ...
    onSubmit(value) {
        if(value.password!==value.passwordConfirm || value.password === "" ||value.phone1===""){
            this.checkPassword = false;
        } else {
            this.checkPassword = true;
            this.updateInfo(value.password,value.phone1,value.phone2,value.email);
            // this.updatePassword(this.checkPassword);
        }
        console.log(this.checkPassword);
    }

    updateInfo(password,phone1,phone2,email) {
        this.user.password = password;
        this.user.phone1 = phone1;
        this.user.phone2 = phone2;
        this.user.email = email;
        var url = this.httpService.getUrl()+"/saveAccount.do";
